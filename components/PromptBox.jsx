...
bg-black p-4 rounded-3xl mt-4 transition-all`}>

    <textarea className='outline-none w-full resize-none overflow-hidden break-words bg-transparent text-amber-50'
    rows={2} placeholder='Message OrionDeepAI' required
    ...
    <div className='flex items-center justify-between text-sm text-amber-50'>
      ...
      <div className='flex items-center gap-2' >
        ...
        <button className={`${prompt ? 'bg-[#649143]' : 'bg-[#71717a}'}
